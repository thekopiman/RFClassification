...
class Extraction:
    ...
    def obtain_files(self, path: str, file_type: str = "csv") -> list[str]:
        """
    ...
    def obtain_classes(self, path: str = None) -> dict[str, int]:
        """
...
def main(args: dict) -> None:
    ...
    Args:
        args (dict): Contains the args from the argparse
    ...
    if args["generate"] != None or args["duplicate_imgs"] != None:
        ...
        print(
            f"train/val/test_list.txt files have been saved at {os.getcwd()}."
    ...
    if args["mode"] == "classes18":
        ...
        for idx, image in enumerate(
            ...
            label_path = os.path.join(args["labels_path"], f"{index}.txt")
            # print(label_path)
