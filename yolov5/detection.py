...
def main(args):
    ...
    assert args['model_path'] != None, "Missing model path"
...
def get_parser():
    ...
    parser = argparse.ArgumentParser("Detection",
                                     description="Detection of signals")
    
    # Mode
    parser.add_argument("-yaml", "--yaml", type=str,
                        help="path of yaml file")
    parser.add_argument("-data", "--data", type=str,
                        help="src directory. Contains all the images to be detected")
    parser.add_argument("-model", "--model-path", type=str,
                        help="path of the model.pt file")
    parser.add_argument("-slice", "--slice", default = False, type= lambda x : str(x).lower() == "true",
                        help="boolean of whether a not to slice the imgs before feeding into the model.")
    parser.add_argument("-dest", "--dest", type=str,
                        help="dest path of directory. If directory DNE, the folder will be created automatically")
...
if __name__ == "__main__":
    ...
    # demo = Detection(
    #     yaml_file=r"/home/jovyan/yolov5/transfer_learning/spectrogram_v3.yaml",
    #     dataset_path=r"/home/jovyan/spectrogram_training_data_20221006/testing",
    #     model_path=r"/home/jovyan/yolov5/runs/train/exp11/weights/best.pt",
    #     to_slice = True,
    # )
    ...
    # demo.wrapper_dir(
    #     write_des=r"/home/jovyan/report_results1/interesting"
    # )
